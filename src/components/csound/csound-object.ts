...
const AudioWorkletGlobalScope = (window as any).AudioWorkletGlobalScope || {};
let CSOUND_NODE_SCRIPT: any;
...
const csound_load_script = function (src: any, callback: any) {
    const script: any = document.createElementNS(
